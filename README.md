...
- Add fixed random seeds for reproducible results.
- Compare Python and SystemC outputs more formally.
- Add runtime or performance comparison between software-only and SystemC-based implementations.
- Extend the model to larger knapsack instances.
- Add waveform tracing for SystemC signal-level analysis.
- Improve documentation of build steps for different operating systems.

## License

No license has been specified for this project yet. If you plan to make this repository public, consider adding a license file.
